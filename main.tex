...
From Fig. \ref{fig:partcvelocity} and Fig. \ref{fig:partcheat}, the maximum thermal efficiency can be approximated to be $2\lessapprox\eta_{th}\lessapprox3$. Fig. \ref{fig:partcdimless} shows the individual efficiencies and the fuel-air mass ratio plotted against the flight Mach number.
