...
\end{figure}
This can be explained by looking at the variability of the Mach numbers of the ram/scramjet engine in Fig. \ref{fig:parthmach}. The nozzle exit Mach is choked for $M_2\leq2.2$ and it is seen that the combustor becomes thermally choked starting at $M_2=0.3$.
...
\end{figure}
The heat per unit mass added in the combustor is calculated from the difference of the squares of the total temperature across the combustor as in Eq. \ref{eqn:q23}. So, at $M_2=1$ there is no heat added to in the combustor as seen in Fig. \ref{fig:parthheat}.
