...
\subsection{\textit{T-s} Diagrams for Validation Cases} % Part A
The \textit{T-s} diagrams for case A and B are plotted in Figure \ref{fig:partavalida} and Figure \ref{fig:partavalidb} respectively. It can be seen that the entropy from state 1-2 and state 3-4 increases 
